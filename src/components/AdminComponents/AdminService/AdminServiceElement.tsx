...
interface IServiceProps {
    ...
    setCurrentDeleteItem: React.Dispatch<React.SetStateAction<IService | null>>;
}
const AdminServiceElement: React.FC<IServiceProps> = ({
    item,
    sendIsLoading,
    setDeleteModal,
...
export default AdminServiceElement;
