...
import styles from "./online-admin.module.scss";

interface IProps {
    item: IOnline;
    sendIsLoading: boolean;
    setDeleteModal: React.Dispatch<React.SetStateAction<boolean>>;
    setCurrentDeleteItem: React.Dispatch<React.SetStateAction<IOnline | null>>;
}

const AdminOnlineElement: React.FC<IProps> = ({
    item,
    sendIsLoading,
    setDeleteModal,
    ...
    return (
        <>
            ...
            <div
                ...
                ${item._id === params["*"] ? styles.link_active : ""}`}
...
export default AdminOnlineElement;
