...
import styles from "./offline-serv-admin.module.scss";
...
interface IProps {
    ...
    setCurrentDeleteItem: React.Dispatch<
        React.SetStateAction<IOfflineServ | null>
    >;
}

const AdminOfflineServElement: React.FC<IProps> = ({
    item,
    sendIsLoading,
    setDeleteModal,
...
export default AdminOfflineServElement;
